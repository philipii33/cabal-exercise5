// components/ui.tsx
// ═══════════════════════════════════════════════════════════════
// SHARED UI PRIMITIVES - Starbucks Green Theme
...
//   GhostButton    — green-bordered glass secondary action
//   Heading        — serif display title + subtitle
//   GreenDot       — tiny brand accent dot
// ═══════════════════════════════════════════════════════════════
...
// ── Primary Button ───────────────────────────────────────────────
// Green gradient fill. Shows spinner while loading.
...
export function PrimaryButton({
  ...
  return (
    ...
    >
      <LinearGradient
        colors={Colors.gradientStart ? [Colors.gradientStart, Colors.gradientEnd] : ["#00704A", "#005B3A"]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
        style={[s.primaryBtn, Shadow.green]}
      >
        {loading ? (
...
// ── Ghost Button ─────────────────────────────────────────────────
// Glass fill + green border. Used for secondary actions.
...
export const GreenDotAlt = GreenDot;
